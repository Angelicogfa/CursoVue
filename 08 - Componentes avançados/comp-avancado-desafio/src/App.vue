<template>
  <div id="app">
    <span>
      <button @click="tipo = 'Vermelho'" class="vermelho">
        Carregar Componente Vermelho
      </button>
      <button @click="tipo = 'Verde'" class="verde">
        Carregar Componente Verde
      </button>
      <button @click="tipo = 'Azul'" class="azul">
    ...
    <component :is="tipo">
      <span>
        Conteúdo do Componente <strong>{{ tipo }}</strong>
      </span>
    </component>
  </div>
</template>
